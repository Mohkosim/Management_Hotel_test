<x-layout>
        ...
        <ol class="inline-flex items-center px-4 space-x-1 md:space-x-2 rtl:space-x-reverse lg:px-12">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="text-sm font-medium text-gray-700 ms-1 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">List</a>
                </div>
            </li>
        </ol>
    </nav>
    ...
    {{-- Title --}}
    <h3 class="px-4 text-3xl font-bold dark:text-white lg:px-12">Housekeeping</h3>


    {{-- search dan date --}}
    <div class="flex items-center max-w-sm mt-6 ml-7">
        {{-- search --}}
    ...
    <section class="bg-white dark:bg-gray-900 sm:p-0">
        <div class="grid grid-cols-1 gap-4 p-3 mt-3 mb-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="h-32 p-4 bg-white border-gray-300 rounded-lg shadow-md dark:border-gray-600 md:h-64">
                <header class="flex justify-center mb-4">
                    <span class="flex w-64 ml-2 text-lg font-medium initial">Free units</span>
                </header>
                <div class="grid grid-cols-3 text-center mt-11">
                    <div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <svg class="w-6 h-6 mx-auto text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 11.917 9.724 16.5 19 7.5" />
                            </svg>

                            @elseif ($currentCondition->current_condition == 'dirty')
                            <svg class="w-6 h-6 mx-auto text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            @else
                            <svg class="w-6 h-6 mx-auto text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <td class="flex items-center px-4 py-3">
                            ...
                            <div id="{{ $currentCondition ? $currentCondition->id : 'default-dropdown' }}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="{{ $currentCondition ? $currentCondition->id : 'default-dropdown-button' }}">
                                    <li>
                                        <form action="{{ route('housekeeping.updateStatus', ['id' => $currentCondition->id]) }}" method="POST">
                                            ...
                                            <button type="submit" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Marks as Clean</button>
                                        </form>
                                    </li>
                                    <li>
                                        <form action="{{ route('housekeeping.updateStatus', ['id' => $currentCondition->id]) }}" method="POST">
                                            ...
                                            <button type="submit" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Clean to be Inspected</button>
                                        </form>
                                    </li>
                                    <li>
                                        <form action="{{ route('housekeeping.updateStatus', ['id' => $currentCondition->id]) }}" method="POST">
                                            ...
                                            <button type="submit" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg -gray-600 dark:hover:text-white">Marks as Dirty</button>
                                        </form>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="grid max-w-lg mx-auto text-center justify-items-center">
            <div class="p-3 mb-4 bg-gray-100 rounded-full dark:bg-gray-500/20">
                <svg class="w-6 h-6 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
