<x-layout>
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse px-4 lg:px-12">
            ...
            <a href="/finance/document_invoice" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                Invoce
            </a>
            </li>
            <li>
            <div class="flex items-center">
                ...
                <a href="/finance/document_invoice" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">List</a>
            </div>
            </li>
        </ol>
    </nav>
                                ...
                                <td class="px-4 py-3 flex items-center">
                                    ...
                                    <div id="{{ $reservation->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="{{ $reservation->id }}-dropdown-button">
                                            <li>
                                                <a href="{{ url('/finance/invoice/pdf/' . $reservation->id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Download</a>
                                            </li>
                                            <li>
